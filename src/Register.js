    ...
    if(logged==false){
        return(
            ...
            <div className = "container shadow pb-5 pt-2" style={{ }} id="mainer">
                ...
                <div className="row mt-3" style={{paddingTop: 110,paddingBottom: 135 }}>
                ...
                <div className=" col-6 mx-auto">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" value={fullName} onChange={handleFullNameChange} className="form-control" id="exampleInputFullName1"   />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" value={rePassword} onChange={handleRePasswordChange} className="form-control" id="exampleInputRePassword1" />
                        </div>
